...
#Scripts path ______________________________________________________________________________________
...
screenshort_path = r"C:\Users\erten\Desktop\Jatvis2\Scripts\Screnshort.ahk"
...
commands = {
    ...
    "introduce yourself": lambda: asyncio.run(play_music(jarvisintroduce)),
...
def start_showing_gif(gif_player=None):
    gif_player.show_gif('speak', duration=5000)
...
if __name__ == "__main__":
    ...
    asyncio.run(showgif())
    asyncio.run(play_music(greeting_sound))
