...
commands = {
    ...
    "screenshort": lambda: script(r"C:\Users\erten\Desktop\Jatvis2\Scripts\Screnshort.ahk"),
    "screenshot":lambda: script(r"C:\Users\erten\Desktop\Jatvis2\Scripts\Screnshort.ahk"),
...
async def showgif(text, duration=5000):
    try:
        ...
        for _ in range(duration // frame_delay):
            ...
            play_gif()
            root.update()
            await asyncio.sleep(frame_delay / 1000.0)
...
if __name__ == "__main__":
    ...
    root.protocol("WM_DELETE_WINDOW", stop_gif)
    root.mainloop()
